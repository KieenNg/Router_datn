...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_10 -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_0_arbiter xil_defaultlib.input_0_arbiter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim input_0_arbiter -key {Behavioral:sim_1:Functional:input_0_arbiter} -tclbatch cmd.tcl -protoinst "protoinst_files/input_0_arbiter.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/socone/3d608d90-f9bc-47ba-a88e-fa074a0a5a5b/socone/tool/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb input_0_arbiter.wdb xsim.dir libdpi.so)

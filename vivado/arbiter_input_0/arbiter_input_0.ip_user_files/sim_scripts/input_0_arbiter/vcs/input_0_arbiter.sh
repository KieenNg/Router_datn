...
design_libs=(xpm xil_defaultlib fifo_generator_v13_2_10 util_vector_logic_v2_0_4)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.input_0_arbiter xil_defaultlib.glbl -o input_0_arbiter_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./input_0_arbiter_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/socone/Documents/DATN/code/router_vivado/arbiter_input_0/arbiter_input_0.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key input_0_arbiter_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc input_0_arbiter_simv.daidir vcs_lib c.obj)

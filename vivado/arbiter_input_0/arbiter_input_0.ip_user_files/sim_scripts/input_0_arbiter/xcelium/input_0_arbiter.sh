...
#
# Script generated by Vivado on Fri May 23 01:56:48 +07 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : input_0_arbiter.sh
...
#
# Usage        : input_0_arbiter.sh
#                input_0_arbiter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_0_arbiter.sh [-reset_run]
#                input_0_arbiter.sh [-reset_log]
#                input_0_arbiter.sh [-help]
#
...
#                script (type 'input_0_arbiter.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname fifo_generator_v13_2_10 -libname util_vector_logic_v2_0_4 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib fifo_generator_v13_2_10 util_vector_logic_v2_0_4)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "input_0_arbiter.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_0_arbiter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.input_0_arbiter xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.input_0_arbiter -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/socone/Documents/DATN/code/router_vivado/arbiter_input_0/arbiter_input_0.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log input_0_arbiter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./input_0_arbiter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: input_0_arbiter.sh [-help]\n\
Usage: input_0_arbiter.sh [-step]\n\
Usage: input_0_arbiter.sh [-lib_map_path]\n\
Usage: input_0_arbiter.sh [-reset_run]\n\
Usage: input_0_arbiter.sh [-reset_log]\n\
Usage: input_0_arbiter.sh [-keep_index]\n\
Usage: input_0_arbiter.sh [-noclean_files]\n\n\
